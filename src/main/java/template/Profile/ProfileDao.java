...
public interface ProfileDao {
    ...
    @SqlUpdate("update profile set rating = :rating, rating_count = :rating_count where user_id = :user_id")
    void updateRating(@Bind("rating") double rating, @Bind("rating_count") int ratingCount, @Bind("user_id") String userId);
}
